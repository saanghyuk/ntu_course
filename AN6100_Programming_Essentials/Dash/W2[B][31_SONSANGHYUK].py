# This Graph is deployed on Heroku Server for easy access.
# https://noel-dash.herokuapp.com/

# Q1
# Analysis Goal : Create a Line Chart to analyze purchases per customer.
# Based on purchase analysis per customer, we can understand current business status and make future strategies.
...
# Q2
# Insight 1:
# Average number of product types, that of quantity and that of amount are all decreasing yearly.
# There has been some big changes in customer behavior and market environment.

# Insight 2:
# We need to think new cross-selling strategy and up-selling strategy.
# We have to find the reasons of this big changes, such as, the emergence of strong competitors, changes in market conditions, etc.
